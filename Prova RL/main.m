...
% PID gains
% Kp = diag([17.7958    9.6811    7.9641]);
% Kd = diag([1.3347    3.2200    1.7545]);

Kp = diag([3.7065   10.0093   22.9206]); %Kp = diag([3.7065   10.0093   22.9206]); 
Kd = diag([10.7001   12.9633   12.8719]); %Kd = diag([10.7001   12.9633   12.8719]);
